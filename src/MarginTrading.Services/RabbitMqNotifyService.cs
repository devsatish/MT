...
namespace MarginTrading.Services
{
	public class RabbitMqNotifyService : IRabbitMqNotifyService
	{
		...
		public async Task AccountHistory(string accountId, string clientId, double amount, double balance, double loan, AccountHistoryType type, string comment = null)
		{
